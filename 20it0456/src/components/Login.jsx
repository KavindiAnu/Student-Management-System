...
const Login = () => {
  ...
  const onSub = async (event) => {
    ...
    if (isvalid) {
      try {
        await axios
          .post("http://localhost/WEBREACT/20IT0456/backend/login.php", {
            role: fields.role,
            nic: fields.nic,
  ...
  const popuperror = () => {
    ...
    return(
        ...
        <section>     
            ...
            <div class="Lheading text-center">Login</div>
            <div class="log-details">
                ...
                <div class="bttn">
                    <div class="d" for="jobType"> Job Role </div>
                <div class="circle">
                    <input type="radio"  name="role" id="role" value="student"
                     onChange={form.handleChangeEvent} onBlur={form.handleBlurEvent} />Student
